    ...
    <>
      ...
      >
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{
                ...
                "--placeholder-color": customization?.selectedTextColor,
              }}
              className={`block w-full p-2 ps-10  border border-gray-300 input-placeholder rounded-[.5rem] bg-transparent  dark:bg-gray-700 dark:border-gray-600   input-height-small`}
        ...
        <div className="overflow-x-auto md:max-w-[50%] lg:max-w-[37%] xl:max-w-[26%] mx-auto px-3">
          <h1
            className="pb-2 text-lg font-semibold text-black"
            style={{ color: customization?.selectedTextColor }}
          >
            {selectedTab}
          </h1>
                  ...
                  <div className="tabs-container overflow-x-auto" key={index}>
                    <div className="flex gap-4">
                      <Button
                        ...
                        style={{
                          backgroundColor: customization?.selectedBgColor,
                        }}
                        className="h-auto w-full !py-0 px-0"
                      >
                        <div
                          key={item.id}
                        ...
                        >
                          ...
                          >
                            <img
                              ...
                              alt="Menu Icon"
                              className="w-full object-cover rounded-[10px] h-28 max-w-28"
                            />
                            <div className="flex items-center justify-between px-3 py-2 mr-auto text-black">
                              <div>
                                <h2
                                  className="text-[20px] mb-0 text-left uppercase"
                                  style={{
                                    color: customization?.selectedTextColor,
                                  }}
                                >
                                ...
                                <h2
                                  className="text-[16px] mb-0 text-left"
                                  style={{
                                    color: customization?.selectedTextColor,
                                  }}
                                >
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                ...
                                toast({
                                  ...
                                  description:
                                    "You can confirm your order in checkout",
                                });
                              }}
                              style={{
                                backgroundColor:
                  ...
                  <div className="tabs-container overflow-x-auto" key={index}>
                    <div className="flex gap-4">
                      <Button
                        ...
                        className="h-auto w-full !py-0 px-0 bg-transparent hover:bg-transparent"
                      >
                        <div
                          key={item.id}
                          className="relative shadow-md rounded-[10px] w-full border-gray-300 border inline-block"
                        >
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between px-3 py-2 text-black">
                              <div>
                                <h2
                                  className="text-[12px] mb-0 text-left"
                                  style={{
                                    color: customization?.selectedTextColor,
                                  }}
                                >
                ...
                >
                  <div
                    className={`text-lg font-semibold ${
                      isClicked ? "text-[#28509E]" : "text-white"
                    } `}
                  >
                    {isClicked
                      ? "Added To Your Cart"
      ...
      <AlertDialog>
        <AlertDialogTrigger
          asChild
          className={`mb-1 fixed bottom-16 right-2 md:right-[25%] lg:right-[32%] xl:right-[35%] flex-col flex items-end justify-center ${
            credenzaOpen ? "hidden" : ""
          }`}
        >
          <Button
          ...
          >
            <img src={Logo} alt="Waiter Icon" className="w-11 h-12" />
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent className="w-[80%] md:w-full mx-auto rounded-lg">
          ...
          <AlertDialogFooter className="flex !flex-col !justify-center  w-full gap-2">
            ...
            <AlertDialogAction className="w-full !ml-0" onClick={submitBille}>
              Bring the bill
            </AlertDialogAction>
