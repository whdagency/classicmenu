    ...
    <>
      <ScrollArea className="h-[900px] w-auto rounded-md border p-4">
        <div className="container">
          <div className="mt-8">
            <div className="flex flex-col items-center justify-center gap-2">
              ...
              <img
                ...
                alt="Menu Icon"
                loading="lazy"
                className="outline-2 outline outline-blue border-1 w-24 h-24 bg-black border border-white rounded-full"
              />
              <div>
                <h1>{items.name}</h1>
              </div>
          ...
          <div className="mt-8">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex items-center gap-5 mt-3">
                {/* <button> */}
                <div className="border-1 border-grey/50 place-content-center grid w-10 h-10 border rounded-full">
          ...
          <div className=" w-full max-w-sm px-2">
            <div className="flex items-center rounded-[1rem] ">
              ...
              <div
                ...
                role="tooltip"
                className="tooltip dark:bg-gray-700 absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0"
              >
          ...
          <div className=" flex items-center justify-center max-w-sm gap-2 pt-10">
            <BsFillTelephoneFill />
